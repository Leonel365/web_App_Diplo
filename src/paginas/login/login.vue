...
<div class="grid grid-cols-6 gap-4">
    <div class="col-start-3 col-span-5">
        <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 bg-gray-700 border-gray-700">
        ...
        <div class="flex items-start">
            ...
            <a href="#" class="ml-auto text-sm text-blue-700 hover:underline dark:text-blue-500">Olvide mi contraseña</a>
        </div>
        ...
        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
            ¿No tienes una cuenta? <a href="#" class="text-blue-700 hover:underline dark:text-blue-500">Crear cuenta</a>
        </div>
        </form>
</div>
    </div>
